 ...
 * 두 출처가 같다(둘 다 중소기업 재직자·연매출 1억원 이하 소상공인으로 좁힌다). **6,000만~7,500만 구간이 어떻게 되는지는 두 문서만으로
...
/** 유형별 소득기준 전체 — 정책브리핑 「청년미래적금 궁금증 총정리」(2026-06-19). 09-15 확인. */
export const YS_BRIEF_URL = "https://www.korea.kr/news/policyNewsView.do?newsId=148966817";
...
export const YS_TIERS: readonly YsTier[] = [
  {
    ...
    label: "우대형",
    rate: 0.12,
    /* 09-15: 소득만 적어 두어 중소기업에 안 다니는 사람도 12%를 고를 수 있었다.
       금융위 보도자료·복지로 원문 둘 다 **중소기업 재직자 또는 연매출 1억원 이하
       소상공인**으로 좁힌다(틀리는 방향이 "더 받는다"). */
    income:
      "중소기업 재직자 총급여 3,600만원(종합소득 2,600만원) 이하 · 중소기업 신규취업자 총급여 6,000만원(종합소득 4,800만원) 이하(가구 중위소득 200% 이하) · 연매출 1억원 이하 소상공인 — 신규취업자 외에는 가구 중위소득 150% 이하",
  },
  {
    id: "general",
    label: "일반형",
    rate: 0.06,
    income:
      "총급여 6,000만원(종합소득 4,800만원) 이하 또는 연매출 3억원 이하 소상공인, 가구 중위소득 200% 이하",
  },
  {
    id: "none",
    label: "기여금 없음",
    rate: 0,
    income:
      "총급여 6,000만원 초과~7,500만원(종합소득 6,300만원) 이하, 가구 중위소득 200% 이하 — 기여금 없이 이자소득 비과세만",
  },
];
