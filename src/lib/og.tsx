      ...
      >
        ...
        <div
          style={{
            ...
            /*
              한국어는 낱말 가운데서 끊으면 안 된다. 기본값으로 두었더니
              "복지 지원금, 어디서 어떻게 신청하 / 나"처럼 마지막 글자 하나만
              다음 줄로 떨어졌다(2026-09-06, 카드 15장 중 여럿이 그랬다).
              `keep-all`은 띄어쓰기에서만 끊게 한다.

              `anywhere`를 같이 주는 이유 — 사업명에는 띄어쓰기가 없는 긴
              덩어리가 있다("초.중.고학생교육정보화지원"). 그런 건 어디서도
              못 끊어 카드 밖으로 삐져나가므로, **끊을 데가 없을 때만**
              중간에서 끊도록 남겨 둔다.
            */
            wordBreak: "keep-all",
