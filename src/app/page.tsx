 ...
 */
/* 2026-09-12 여덟 → **열**. 사용자가 "1-10순위"로 정했다. 순위표 한 줄이
   375px에서 약 62px이라 두 줄이 늘어도 첫 화면이 124px만 길어진다 —
   09-10에 카드 여덟 장(1,700px)을 이 순위표로 바꾸며 번 자리 안이다. */
const popular = services.slice(0, 10);
