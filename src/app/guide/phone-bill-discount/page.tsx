...
export const metadata: Metadata = {
  ...
  description:
    "통신요금 감면은 유형마다 계산식이 다릅니다. 과학기술정보통신부 고시의 감면 조문을 옮기고, 한 달 요금을 넣으면 감면액이 나오게 했습니다. 집 인터넷이 함께 감면되는 유형과 휴대폰만 되는 유형도 갈라 적었습니다.",
    ...
    <>
      ...
      >
        ...
        <DocSection title="최대 금액은 이렇게 나옵니다">
          ...
          />
          <p>
            그래서 <strong>요금이 싸면 유형 사이 차이가 줄어듭니다.</strong> 월 11,000원 요금제라면
