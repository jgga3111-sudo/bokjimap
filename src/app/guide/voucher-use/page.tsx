...
export const metadata: Metadata = {
  ...
  description:
    "2026년 문화누리카드는 1인당 15만원이고 청소년·준고령은 1만원이 더 붙습니다. 안 쓰고 남은 지원금은 12월 31일 23시 59분이 지나면 국고로 돌아갑니다. 잔액 확인, 세대 합산, 재발급 기한을 한국문화예술위원회 공식 안내로 정리했습니다.",
    ...
    <>
      ...
      >
        <DocSection title="2026년에 얼마가 들어오나">
          <p>
            1인당 <strong>연 15만원</strong>이고, 두 연령대에는 <strong>생애주기별 1만원</strong>이
