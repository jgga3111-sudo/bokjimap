...
export const metadata: Metadata = {
  title: "지원금 지급일 — 기초연금·아동수당·장애수당은 매월 며칠에 들어오나",
  description:
    "보훈급여금은 매월 15일, 생계급여·주거급여·장애인연금·장애수당은 20일, 기초연금·아동수당은 25일에 들어옵니다. 토요일이나 공휴일이면 그 전날입니다. 시행령·시행규칙 조문을 그대로 옮겼습니다.",
      ...
      >
        ...
        <DocSection title="그날이 토요일이거나 공휴일이면">
          {/* "다섯"이라고 손으로 적었다가 고쳤다. 제도가 하나 늘면 조용히
              ...
              2026-09-07에 한 번 더 걸렸다. 여기 "전부 같은 괄호를 달고
              있습니다 — '토요일이거나 공휴일인 경우에는 그 전날로 한다'"라고
              적혀 있었는데, 그날 더한 보훈급여금 조문은 **'토요일이나
              공휴일인 경우에는 그 전날에 지급한다'**로 문장이 다르다.
              뜻은 같지만 "전부 같은 문장"은 그 순간 사실이 아니게 됐다.
              원문을 그대로 옮기기로 한 이상, 원문이 다르면 그렇다고 쓴다. */}
          <p>
            <strong>그 전날에 들어옵니다.</strong> 위에 실은{" "}
            {PAY_DATES.length - IRREGULAR.length}개 사업의 조문이 하나도 빠짐없이 이
            단서를 달고 있습니다.
          </p>
          <p>
            다만 <strong>문장은 법마다 조금씩 다릅니다.</strong> 복지 쪽 조문은
            날짜 옆 괄호에 &ldquo;토요일이거나 공휴일인 경우에는 그 전날로
            한다&rdquo;라고 적고, 보훈 쪽 조문은 문장을 따로 떼어 &ldquo;보훈급여금의
            지급일이 토요일이나 공휴일인 경우에는 그 전날에 지급한다&rdquo;(국가유공자법
            시행령 제29조제1항)처럼 적습니다. 결론은 같습니다 — 앞당깁니다.
          </p>
          {/*
        ...
        <DocSection title="여기 없는 것">
          ...
          <p>
            <strong>조문은 있는데 뺀 것도 있습니다.</strong> 5·18민주유공자
            학습보조비는 &ldquo;제1학기분은 4월 15일에, 제2학기분은 10월
            15일에&rdquo;라고 날짜가 못 박혀 있지만, 저희 목록에 그 사업이
            없어 실을 자리가 없었습니다. 이 글은 <strong>수록한 사업에 이어
            붙일 수 있는 것</strong>만 다룹니다.
          </p>
          <p>
