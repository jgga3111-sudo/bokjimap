...
export default function AboutPage() {
  return (
    ...
    <DocPage
      title="사이트 소개"
      lead="복지 정보는 정부 부처와 243개 지방자치단체에 따로따로 있습니다. 복지클릭은 그걸 한곳에 모아, 내 상황에 맞는 것부터 찾을 수 있게 만듭니다. 받을 수 있는지 판정하지는 않습니다."
    >
      ...
      <DocSection title="원문에 없는 것은 따로 확인합니다">
        <p>
          ...
          경우가 많습니다. 그런 값은 법령 조문, 부처 고시, 정부가 낸 사업안내서를 읽고
          찾아 출처와 확인일을 함께 적습니다.
        </p>
        <DocList
          items={[
      ...
      <DocSection title="어떻게 확인하나">
        <DocList
          items={[
            ...
            <>
              <strong>글은 AI 도구의 도움을 받아 씁니다.</strong> 출처를 찾고 읽고 초안을 쓰는 데 AI를
              쓰고, 싣기 전에 금액·조건·쪽수를 원문과 대조합니다. 원문에서 확인되지 않는 문장은 싣지
              않으며, 내용의 책임은 운영자에게 있습니다.
            </>,
            <>
